...
mongoose.connect("mongodb://localhost:27017/adopme");

// Describir nuestro test
describe("Test UserDao", () => {
  const adoptionDao = new AdoptionService
  let userTest;
  ...
  // Test individual
  it("Debe retornar todos los adoptions", async () => {
    const adoptions = await adoptionDao.getadoptions()
    console.log("adocccion",adoptions)
